...
class Passenger {
  ...
  factory Passenger.fromJson(Map<String, dynamic> json) {
    //?the air line is type list but contains just one map 
    //?so we get the list first then user the first element in it.
    List airLineData = json['airline'];
    return Passenger(
      id: json["_id"],
      name: json["name"],
      trips: json["trips"],
      airline: Airline.fromJson(airLineData.first),
      v: json["__v"],
    );
  }
